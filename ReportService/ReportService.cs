...
namespace ReportService
{
    public partial class ReportService : ServiceBase
    {
        ...
        private StringCipher _stringCipher = new StringCipher("54747E3F-8F2A-44BC-826E-41BE380A13DE");
        ...
        private string DecryptSenderEmailPassword()
        {
            ...
            if (encryptedPassword.StartsWith(NotEncryptedPassPrefix))
            {
                encryptedPassword = _stringCipher.Encrypt(encryptedPassword.Replace(NotEncryptedPassPrefix, ""));
